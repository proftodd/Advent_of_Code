...
public struct Day_02 {
    public static func main() throws {
        ...
        let finalScore = Game.scoreCollectionOfGames(games: lines, scoringMethod: Game.scoreGame)
        let finalScoreWithStrategy = Game.scoreCollectionOfGames(games: lines, scoringMethod: Game.scoreGameWithStrategy)
